"""Argument parser for elf_size_analyze"""
...
For best results the program should be compiled with maximum debugging
information (e.g. GCC flag: `-g`, or more: `-ggdb3`).
    """, epilog="""
...
RAM/ROM options may be oversimplifed for some targets, under the hood they
just filter the symbols by sections in the following manner:
sections must have ALLOC flag and: for RAM - have WRITE flag,
for ROM - not have NOBITS type.
        """)
