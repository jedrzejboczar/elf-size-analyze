...
class Section:
    ...
    def print(cls, sections):
        ...
        for s in sections:
            ...
            lines.append(fields)
        sizes = [max(len(line[i]) for line in lines) for i in range(6)]
    ...
    def extract_sections_info(cls, elf_file, readelf_exe='readelf'):
        ...
        sections = [Section.from_readelf_line(line) for line in readelf_proc.stdout]
